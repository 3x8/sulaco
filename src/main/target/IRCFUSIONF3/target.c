...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    DEF_TIM(TIM3,  CH1,  PA6,  TIM_USE_MOTOR,             0), // PWM1 - PA6  - TIM3_CH1, TIM8_BKIN, TIM1_BKIN, *TIM16_CH1
    DEF_TIM(TIM17, CH1,  PA7,  TIM_USE_MOTOR,             0), // PWM2 - PA7  - TIM3_CH2, *TIM17_CH1, TIM1_CH1N, TIM8_CH1
    DEF_TIM(TIM1,  CH1N, PA11, TIM_USE_MOTOR,             0), // PWM3 - PA11
    DEF_TIM(TIM1,  CH2N, PA12, TIM_USE_MOTOR,             0), // PWM4 - PA12
    ...
    DEF_TIM(TIM1,  CH1,  PA8,  TIM_USE_MOTOR,             0), // GPIO_TIMER / LED_STRIP
};
