...
const clivalue_t valueTable[] = {
  ...
  {"dcm_fastgain",                 VAR_UINT8  | MASTER_VALUE, .config.minmax = { 1, 100 }, PG_IMU_CONFIG, offsetof(imuConfig_t, dcm_fastgain) },
  // PG_ARMING_CONFIG
  ...
  {"rate_acc_limit_yaw",           VAR_UINT16 | PROFILE_VALUE, .config.minmax = { 0, 500 }, PG_PID_PROFILE, offsetof(pidProfile_t, yawRateAccelLimit) },
  {"rate_acc_limit",               VAR_UINT16 | PROFILE_VALUE, .config.minmax = { 0, 500 }, PG_PID_PROFILE, offsetof(pidProfile_t, rateAccelLimit) },
  ...
  // PG_OSD_CONFIG
    ...
    {"osd_remaining_time",         VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, OSD_POSCFG_MAX }, PG_OSD_CONFIG, offsetof(osdConfig_t, item_pos[OSD_REMAINING_TIME_ESTIMATE]) },
  ...
  // PG_CAMERA_CONTROL_CONFIG
    ...
    {"camera_control_resistance",  VAR_UINT16 | MASTER_VALUE, .config.minmax = { 10, 1000 }, PG_CAMERA_CONTROL_CONFIG, offsetof(cameraControlConfig_t, internalResistance) },
