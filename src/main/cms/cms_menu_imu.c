...
static uint16_t cmsx_pid_kalman_w;
static uint16_t cmsx_pid_kalman_q;
...
static OSD_Entry cmsx_menuFilterPerProfileEntries[] =
{
    ...
    { "PID KALMAN W",  OME_UINT16, NULL, &(OSD_UINT16_t){ &cmsx_pid_kalman_w,  0, 500, 1 }, 0 },
    { "PID KALMAN Q",  OME_UINT16, NULL, &(OSD_UINT16_t){ &cmsx_pid_kalman_q,  0, 500, 1 }, 0 },
