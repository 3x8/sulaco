...
PG_RESET_TEMPLATE(currentSensorADCConfig_t, currentSensorADCConfig, .scale = CURRENT_METER_SCALE_DEFAULT, .offset = CURRENT_METER_OFFSET_DEFAULT, );
...
// API for current meters using IDs, is used by MSP, for configuration/status.
